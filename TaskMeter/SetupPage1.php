            ...
            <div class="cardbody" id = "cardbody" name = "cardbody">
                ...
                <div class="prof-in-charge">-->
                    <div class="profname">
                        ...
                        <input type="text" name="group_id" placeholder="Group ID" id = "group_id" value = "<?php echo $_SESSION['group_id']?>" readonly>
                    </div>
                </div>
        </form>
                    <thead>
                ...
                <form action="confirmSetup.php" method="post">
