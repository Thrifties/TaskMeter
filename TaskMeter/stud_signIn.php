...
<body id="signinlog1-body">
<div>
	<div class="container" id="container">
		<div class="form-container sign-up-container">

		<form action="addstud.php" method="post">
			<h1 class = "WhiteBox" id="signinlog1-h1">Create Account</h1>
			<!-- <p class = "WhiteBox" id="signinlog1-p">Sign up using: </p>
			...
			<h3 id="signinlog1-h3"><span id="signinlog1-span">or</span></h3> -->
			<div class = "in_up_labels">Username</div>
			<input type="text" id = "username" name="studID" placeholder="Student ID" required>
			<div class = "in_up_labels">First Name</div>
			<input type="text" name="fname" placeholder="First Name"style="text-transform:capitalize;" required>
			...
			<button id = "SignUpbtn" name="SignUpbtn" type ="submit">SignUp</button>
		</form>
		</div>
		<div class="form-container sign-in-container">
			<form action="toLoginStud.php" method="post">
				<h1 class = "WhiteBox" id="signinlog1-h1">Sign In	</h1>
			<!-- 	<div class="social-container">
				<a href="#" style="background-color:#3b5998" class="social" ><i class="fa fa-facebook" ></i></a>
				<a href="#" style="background-color: #db4a39" class="social"><i class="fa fa-google"></i></a>
				<a href="#" style="background-color: #0072b1" class="social"><i class="fa fa-linkedin"></i></a>
			...
			<h3 id="signinlog1-h3"><span id="signinlog1-span">or</span></h3> -->
			<div class = "in_up_labels">Student ID</div>
		...
		<div class="overlay-container">
			<div class="overlay">
				<div class="overlay-panel overlay-left">
					<h1 class = "GradeBox" id="signinlog1-h1">Welcome Back!</h1>
					<p class = "GradeBox" id="signinlog1-p">To keep connected with us please login with your personal info</p>
					<button class="ghost" id="signIn" onclick="changeImage('TaskMeterLogo.png')">Sign In</button>
				</div>
				<div class="overlay-panel overlay-right">
					<h1 class = "GradeBox" id="signinlog1-h1">Hello, Friend!</h1>
					<p  class = "GradeBox"id="signinlog1-p">Enter your details and start journey with us</p>
					<button class="ghost" id="signUp" onclick="changeImage('TaskMeter Logo (1) (1).png')">Sign Up</button>
				</div>
			</div>
		</div>
		<div id="logocontainer">
			<img src="TaskMeterLogo.png" height=auto width="150" id="logo" ></img>
		</div>
...
$(document).on("blur", "#username", function(){
	...
	$(document).on("blur", "#username", function(){
		...
		icon: "error",
		iconColor: "#FF2E2E",
		text:"Student ID should be 10 characters",
		showConfirmButton: false,
		timer: 2000,
		})
		.then(function(){
