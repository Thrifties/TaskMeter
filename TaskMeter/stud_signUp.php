	...
	<div class="overlay-container">
		<div class="overlay">
			<div class="overlay-panel overlay-left">
				<h1 class = "GradeBox" id="signuplog1-h1">Welcome Back!</h1>
...
$(document).on("blur", "#username", function(){
	...
	$(document).on("blur", "#fname", function(e){
		var fposValue = fname.value.trim();
		var letters = '/^([^0-9]*)$/';
		if(fposValue.match(letters)){
	...
	$(document).on("blur", "#lname", function(){
		var lposValue = lname.value.trim();
		var letters = "/^[A-Za-z]+$/";
		if(lposValue.value.match(letters)){
		}
		else{
			Swal.fire({
			icon: "error",
